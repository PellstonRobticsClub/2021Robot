...
joystickButton5.whileHeld(new SpinShooter( m_shooter ) ,true);
    SmartDashboard.putData("Joystick Button 5",new SpinShooter( m_shooter ) );

final JoystickButton joystickButton1 = new JoystickButton(joystick1, 1);        
joystickButton1.whenPressed(new DriveSetSpeed(1, 0, m_driveTrain).withTimeout(2.0) ,true);
    SmartDashboard.putData("Joystick Button 1",new DriveSetSpeed(1, 0, m_driveTrain).withTimeout(2.0) );
  ...
  new JoystickButton(joystick1, 2)
    .whenPressed(() -> m_shooter.SpinShooter(-.75))
